...
extension JZBaseWeekView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    open func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case JZSupplementaryViewKinds.columnHeader:
            ...
            columnHeader.numofDays = numOfDays
        ...
        case JZSupplementaryViewKinds.rowHeader:
            ...
            rowHeader.lblTime.textColor = UIColor.darkText
            if indexPath.row == 0 || indexPath.row == 24 {
                rowHeader.lblTime.isHidden = true
            }else{
                rowHeader.lblTime.isHidden = false
            }
    ...
    public func setHorizontalEdgesOffsetX() {
        ...
        print("currentPageFirstDate = ", currentPageFirstDate)
        print("currentPageLastDate = ", currentPageLastDate)
