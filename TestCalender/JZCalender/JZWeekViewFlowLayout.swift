...
open class JZWeekViewFlowLayout: UICollectionViewFlowLayout {
    ...
    open var defaultHourHeight: CGFloat { return 60 }
    open var defaultRowHeaderWidth: CGFloat { return 60 }
    ...
    open var contentsMargin: UIEdgeInsets { return UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0) }
